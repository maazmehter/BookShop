...
public partial class Checkout : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["CC_No"] != null)
        {
            ...
            cmd.CommandText = "Insert into Orderline (OrderID, BookID, Quantity) " +
                              "Select " + Session["orderID"] + ", ShopcartLine.BookID, Quantity " +
                              "From ShopcartLine inner join Books on ShopcartLine.BookID=Books.BookID " +
    ...
    protected void Page_LoadComplete(object sender, EventArgs e)
    {
        ...
        string strEmailFrom = "latapiyaa@gmail.com"; //put a valid gmail account here to represent the company's email.
        ...
        strEmailBody =
               strEmailBody + "You have purchased the following Books(s) from us:<br/><br/>";
        ...
        //Note: You might want to create a new Gmail account just for this project
        smtpClient.Credentials =
            new System.Net.NetworkCredential("latapiyaa@gmail.com", "babyQ123+");
        ...
        //redirect to download page from which user can download purchased Books(s)
